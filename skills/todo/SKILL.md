---
name: todo
description: Maintain TODO.md as the living source of truth for implementation work. Triggers when given multi-step instructions to build or change code.
---

# TODO Management

`TODO.md` at the project root is the source of truth — not conversation memory.
Update it **before** announcing any completion or asking any question.

## Planning (new instruction)

Decompose into `- [ ]` items and write `TODO.md`.
...
Mark done (`- [ ]` → `- [x]`) after REFACTOR completes, then show updated `TODO.md`.
